    ...
    <div className="space-y-6">
      ...
      >
        ...
        <TabsContent value="available" className="space-y-6">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex-1">
              <div className="rounded-md grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-3 py-2 overflow-y-scroll sm:h-[73vh] scrollbar-thin scrollbar-thumb-purple-700 scrollbar-track-purple-300">
                <AnimatePresence>
                  <UtmifyIntegration
        ...
        <TabsContent value="my-integrations" className="space-y-3">
          ...
          <div className="space-y-4 py-3 rounded-md overflow-y-scroll sm:h-[70vh] scrollbar-thin scrollbar-thumb-purple-700 scrollbar-track-purple-300">
            {loading ? (
